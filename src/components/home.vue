  ...
  mounted() {
    ...
    this.introduction_text =
      "<ul>" +
        ...
        "<li>实验室团队成员简介：ACM/IEEE Fellow，国家特聘教授，在顶级期刊和著名国际会议上发表300余篇文章（Google Scholar被引用次数超过22,000次，H-Index 65）。现任包括ACM/IEEE TON，IEEE TC, ACM TOSN在内的七个国际期刊的编委，获八项国际会议的最佳论文奖（包括业界顶会MobiCom，SenSys和ICDCS）。</li>" +
