...
<!--                    <span class="small">{{ item }}</span>-->
        ...
        <div class="news" :style="isMobile? 'padding: 0.2rem 0.4rem': 'padding: 0.4rem 1rem'">
            <div v-for="item in news" :key="item" class="news-item" @click="to_news_item(item)" >
                <el-row>
                    <el-col :span="14"><div class="news-item-title">{{item.title}}</div></el-col>
                    <el-col :span="10"><div class="news-item-time">{{item.time}}</div></el-col>
                </el-row>
            </div>
        </div>
    </div>
...
<script>
    export default {
        ...
        mounted() {
            ...
            this.introduction_text= "这是一段很长的简介这是一段很长的简介这是一段很长的简介这是一段很长的简介这是一段很长的简介这是一段很长的简介这是一段很长的简介这是一段很长的简介\n" +
